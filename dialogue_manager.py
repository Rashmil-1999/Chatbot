...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        question_vec = question_to_vec(
            question, self.word_embeddings, self.embeddings_dim)  # YOUR CODE HERE ####
        best_thread = pairwise_distances_argmin(
            X=[question_vec], Y=thread_embeddings, metric='cosine')[0]  # YOUR CODE HERE ####
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        self.chitchat_bot = ChatBot('jar_viss_bot')
